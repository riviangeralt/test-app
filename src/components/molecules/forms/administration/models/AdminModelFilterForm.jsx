...
const AdminModelFilterForm = (props) => {
  ...
  return (
    <>
      ...
      <Suspense fallback="">
        {isModalOpen && (
          <AddModelsModal isOpen={isModalOpen} onClose={handleModalClose} />
        )}
      </Suspense>
    </>
  );
...
AdminModelFilterForm.propTypes = {
  refreshData: PropTypes.func,
}

export default AdminModelFilterForm;
